...
export default function ListingFormClient({
    ...
    return (
        <>
            ...
            <Header currentPage={"create"} isEditing={isEditing} isOwnProfile={true} />
            {/* Form */}
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            {conditions.map((cond) => (
                                <button
                                    ...
                                    disabled={isSubmitting}
                                    className={`px-4 py-3 border-2 rounded-lg text-sm font-medium transition disabled:opacity-50 disabled:cursor-not-allowed ${formData.condition === cond.id
