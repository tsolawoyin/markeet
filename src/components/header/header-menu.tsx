    ...
    <Popover>
      ...
      >
        ...
        {user ? (
          ...
          <button
            onClick={handleSignOut}
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-md text-sm text-green-600 dark:text-green-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition"
          >
            <LogOut className="w-4 h-4" />
            <span>Sign In</span>
          </button>
